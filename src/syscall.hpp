// syscall.hpp -- Defines the interface for and structures relating to the syscall dispatch system.
...
DECL_SYSCALL1(monitor_write_hex, int)
DECL_SYSCALL1(monitor_write_dec, int)
